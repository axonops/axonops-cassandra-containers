...
[![Latest Version](https://img.shields.io/badge/dynamic/json?url=https://ghcr-badge.elias.eu.org/api/axonops/axonops-cassandra-containers/axonops-cassandra-containers&query=$.version&label=version)](https://github.com/axonops/axonops-cassandra-containers/pkgs/container/axonops-cassandra-containers)
[![Image Size](https://img.shields.io/badge/dynamic/json?url=https://ghcr-badge.elias.eu.org/api/axonops/axonops-cassandra-containers/axonops-cassandra-containers&query=$.size&label=size)](https://github.com/axonops/axonops-cassandra-containers/pkgs/container/axonops-cassandra-containers)
